...
function getRadios(selected) {
	...
	if (welfare_sports != '' ) {
		html += "<li id = 'welfare_sports' value = " + welfare_sports + ">" + '스포츠시설' 
		+'<a href="#" class = "remove" click="removeList1();>   x   </a> '+ "</li>";
	...
	if (welfare_culture != '') {
		html += "<li id = 'welfare_culture' value = " + welfare_culture + ">" + '문화시설' 
		+'<a href="#" class = "remove" click="removeList2();">   x   </a> '+ "</li>";
	}
	...
	if (welfare_salon != '') {
		...
		+'<a href="#" class = "remove" click="removeList3();">   x   </a> '+ "</li>";
	}
	...
	if (welfare_society != '') {
		html += "<li id = 'welfare_society' value = " + welfare_society + ">" + '사회복지시설' 
		+'<a href="#" class = "remove" click="removeList4();">   x   </a> '+ "</li>";
	...
	if (welfare_medical != '') {
		html += "<li id = 'welfare_medical' value = " + welfare_medical + ">" + '의료시설' 
		+'<a href="#" class = "remove" click="removeList5();">   x   </a> '+ "</li>";
	}
	...
	if (welfare_childcare != '') {
		html += "<li id = 'welfare_childcare' value = " + welfare_childcare + ">" + '보육시설' 
		+'<a href="#" class = "remove" click="removeList6();">   x   </a> '+ "</li>";
	}
	...
	if (education_student != '') {
		...
		+'<a href="#" class = "remove" click="removeList7();">   x   </a> '+ "</li>";
	}
	...
	if (education_academy != '') {
		...
		+'<a href="#" class = "remove" click="removeList8();">   x   </a> '+ "</li>";
	}
	...
	if (safety_fire != '') {
		html += "<li id = 'safety_fire' value = " + safety_fire + ">" + '화재안전사고' 
		+'<a href="#" class = "remove" click="removeList9();">   x   </a> '+ "</li>";
	}
	...
	if (safety_traffic != '') {
		html += "<li id = 'safety_traffic' value = " + safety_traffic + ">" + '교통안전사고' 
		+'<a href="#" class = "remove" click="removeList10();">   x   </a> '+ "</li>";
	}
	...
	if (safety_crime != '') {
		html += "<li id = 'safety_crime' value = " + safety_crime + ">" + '교통안전사고' 
		+'<a href="#" class = "remove" click="removeList11();">   x   </a> '+ "</li>";
	}
	...
	if (safety_safety != '') {
		html += "<li id = 'safety_safety' value = " + safety_safety + ">" + '안전사고' 
		+'<a href="#" class = "remove" click="removeList12();">   x   </a> '+ "</li>";
	}
	...
	if (safety_infection != '') {
		html += "<li id = 'safety_infection' value = " + safety_infection + ">" + '전염병' 
		+'<a href="#" class = "remove" click="removeList13();">   x   </a> '+ "</li>";
	}
	...
	if (safety_nature != '') {
		html += "<li id = 'safety_nature' value = " + safety_nature + ">" + '자연재해' 
		+'<a href="#" class = "remove" click="removeList14();">   x   </a> '+ "</li>";
	}
	...
	if (life_convenient != '') {
		html += "<li id = 'life_convenient' value = " + life_convenient + ">" + '편의시설' 
		+'<a href="#" class = "remove" click="removeList15();">   x   </a> '+ "</li>";
	}
	...
	if (life_shopping != '') {
		html += "<li id = 'life_shopping' value = " + life_shopping + ">" + '쇼핑시설' 
		+'<a href="#" class = "remove" click="removeList16();">   x   </a> '+ "</li>";
	}
	...
	if (life_restaurant != '') {
		html += "<li id = 'life_restaurant' value = " + life_restaurant + ">" + '외식시설' 
		+'<a href="#" class = "remove" click="removeList17();">   x   </a> '+ "</li>";
	}
	...
	if (life_publicTraffic != '') {
		html += "<li id = 'life_publicTraffic' value = " + life_publicTraffic + ">" + '외식시설' 
		+'<a href="#" class = "remove" click="removeList18();">   x   </a> '+ "</li>";
	}
	...
	if (people_foreign != '') {
		html += "<li id = 'people_foreign' value = " + people_foreign + ">" + '외국인비율' 
		+'<a href="#" class = "remove" click="removeList19();">   x   </a> '+ "</li>";
	}
	...
	if (people_density != '') {
		html += "<li id = 'people_density' value = " + people_density + ">" + '인구밀도' 
		+'<a href="#" class = "remove" click="removeList20();">   x   </a> '+ "</li>";
	}
	...
	if (nature_park != '') {
		html += "<li id = 'nature_park' value = " + nature_park + ">" + '주변 공원 수' 
		+'<a href="#" class = "remove" click="removeList21();">   x   </a> '+ "</li>";
	}
	...
	if (nature_pollution != '') {
		html +="<li id = 'nature_pollution' value = " + nature_pollution + ">" + '미세먼지' 
		+'<a href="#" class = "remove" onclick="removeList22();">  x   </a> '+ "</li>";
		/*+'<a href="#" class = "remove" onchange="removeList('+ selected + ","+ "rd_nature_pollution");">   x   </a> '+ "</li>";*/
	//onclick = "removeList(' + selected.rd_nature_pollution.checked = false +')
	}
